...
class Client(object):
    ...
    def __init__(self):
        __connectionString = 'Driver={SQL Server};Server=tcp:rdlu1d1px9.database.windows.net,1433;Database=QuizDB;Uid=mikey@rdlu1d1px9;Pwd=P@ssw0rd;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;';
